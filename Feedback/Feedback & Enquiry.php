<?php
include 'sendFeedbackEnquiry.php';
?>
...
<head>
    ...
    <title>Feedback & Enquiry Form</title>
...
<body>
        ...
        <nav>
            <ul class="nav_links">
                ...
                <li><a class="nav-items" href="#"
                        style="pointer-events: none; color:wheat; border: 2px solid darkred;padding: 1px 1px 1px 1px;">Feedback
                        or Enquiry</a></li>
            </ul>
            <form>
    ...
    <div class="control-content">
        <div class="left-side">
            <h2>Ask StudyMalaysia</h2>
            <p>Come write to us. We are always here to assist you.</p>
        </div>
       ...
       $fullUrl = "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
         ...
         elseif (strpos($fullUrl, "error=InvalidContactNumber") == TRUE){
          echo "<div class = 'error' style='border: 4px solid black;width:300px;height:30px;text-align:center;margin-left:30px;padding-top:10px;font-weight:bold;color:red;'>Contact Number Wrong Format!</div>";
            ...
            <form method='POST'>
                ...
                <div>
                    ...
                    <textarea type="textarea" name="address"
                        style="width:270px; height:150px; font-family: -apple-system; font-size:13px; resize:horizontal"
                        required></textarea>
                </div>
                <div>
                    <p>Nationality</p>
                ...
                <div>
                    ...
                    <input type="text" name="course" required></input>
                </div>
                <table>
                <tr>
                <td><div>
                    <p>Comments</p>
                    <textarea type="textarea" class='feedback' name="feedback"
                        style="width:270px; height:150px; font-family: -apple-system; font-size:13px;  resize:horizontal;" placeholder="Comments..."
                        required></textarea>
                </div></td>
                <td> <div style="float:left; margin-left:15px;margin-top: 40px; border: 5px solid #CD5C5C; color: darkred;padding:15px;font-weight: bold;">
                   Please select the comment type:
                    <div style="display:flex; justify-content:space-evenly; margin-left:0px;">

                        <div class='feedback' style="padding:10px; margin-left:0px; margin-top:10px; background-color: #7e2727; color:white; cursor:pointer;">
                            Feedback
                        </div>

                        <div class='enquiry' style="padding:10px; margin-left:0px; margin-top:10px; background-color: #7e2727; color:white; cursor:pointer;">
                            Enquiry
                        </div>
        ...
        <div class="right-side">
            <img src = "feedback.jpg" alt="enquiry">
        </div>
    </div>
    ...
    <footer>
        <div class="main-footer">
            ...
            <div class="center">
                ...
                <p><a href="#" style="text-decoration: none; color:white;">Feedback or Enquiry</a></p>
            </div>
            <div class="right-side">
    ...
    <script>
        document.querySelectorAll('.feedback')[1].onclick = function(){
            document.querySelectorAll('.feedback')[1].style.border = "5px solid #ccc";
            document.querySelector('.enquiry').style.border = "0px";
            document.querySelectorAll('.feedback')[0].style.display = 'inline';
            document.querySelectorAll('.feedback')[0].name = 'feedback';
        }

        document.querySelector('.enquiry').onclick = function(){
            document.querySelector('.enquiry').style.border = "5px solid #ccc";
            document.querySelectorAll('.feedback')[1].style.border = "0px";
            document.querySelectorAll('.feedback')[0].style.display = 'inline';
            document.querySelectorAll('.feedback')[0].name = 'enquiry';
        }

        document.querySelectorAll('.feedback')[1].onclick(); // opens the specific onclick() associated with the element
        //document.querySelectorAll('.feedback')[1].click(); // opens all click events associated with the element
    </script>
