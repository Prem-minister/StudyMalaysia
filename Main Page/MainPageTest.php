...
<body>
    ...
    <header>
        ...
        <nav class='nav' style='width:1300px;'>
            <ul class="nav_links">
        ...
        if (isset($_SESSION['ID'])) {
            ...
            echo "<div class='login-nav'>
                    <button style = 'cursor:pointer;border:1px solid black;width:90px;height:30px;border-radius:3px;background-color:darkred;color:white;' onclick=directLocation('../Login/student_register.php');>Sign Up</button>
                    <button style = 'cursor:pointer;margin-left:20px;border:1px solid black;width:95px;height:30px;border-radius:3px;background-color:darkred;color:white;' onclick=directLocation('../Login/mainlogin.php');>Login as Student</button>
                    <button style = 'cursor:pointer;margin-top:20px;margin-left:50px;border:1px solid black;width:90px;height:30px;border-radius:3px;background-color:darkred;color:white;' onclick=directLocation('../Login/mainloginAdmin.php');>Login as Admin</button>
                </div>";
        }
        ...
        <?php
            if(isset($_GET['newpwd'])){
                ...
                echo '<center><p class="Success" style="border: 3px solid black;width:250px;height:30px;text-align:center;margin:auto; font-weight:bold;color:#FFFC00;">Password Reset Success</p></center>';
            }
        }
        ?>
